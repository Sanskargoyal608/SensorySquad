...
namespace Unity.XRContent.Interaction.Analytics
{
    ...
    abstract class EditorEvent
    {
        ...
        internal AnalyticsResult Register()
        {
#if UNITY_EDITOR
            return EditorAnalytics.RegisterEventWithLimit(m_EventName, m_MaxEventsPerHour, m_MaxElementCount, XrcAnalytics.k_VendorKey);
#else
