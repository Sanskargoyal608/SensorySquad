...
namespace Unity.XRContent.Interaction
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        void StartTeleport(InputAction.CallbackContext obj)
        {
            ...
            InputMediator.ConsumeControl(GetInputAction(m_TeleportModeActivate), false);
            InputMediator.ConsumeControl(GetInputAction(m_TeleportModeCancel), false);
        }
        ...
        void CancelTeleport(InputAction.CallbackContext obj)
        {
            ...
            InputMediator.ReleaseControl(GetInputAction(m_TeleportModeActivate));
            InputMediator.ReleaseControl(GetInputAction(m_TeleportModeCancel));
        }
        ...
        {
            RayInteractorUpdate();
            InputMediator.ConsumeControl(m_Select.action, true, true);
        }
        ...
        void RaySelectEntered(SelectEnterEventArgs args)
        {
            ...
            InputMediator.ConsumeControl(m_AnchorTranslate.action, false, true, m_AnchorRotate.action);
            InputMediator.ConsumeControl(m_AnchorRotate.action, false, false);
        }
        ...
        void RaySelectExited(SelectExitEventArgs args)
        {
            ...
            InputMediator.ReleaseControl(m_AnchorTranslate.action, false);
            InputMediator.ReleaseControl(m_AnchorRotate.action, false);
        }
        ...
        void Update()
        {
            ...
            if (turnSelectAction != null)
            {
                if (turnSelectAction.phase == InputActionPhase.Started || turnSelectAction.phase == InputActionPhase.Performed)
                    InputMediator.ConsumeControl(turnSelectAction, false, false, snapTurnAction, turnAction);

                if (turnSelectAction.phase == InputActionPhase.Canceled || turnSelectAction.phase == InputActionPhase.Waiting)
                    InputMediator.ReleaseControl(turnSelectAction, false);
            }
            ...
            if (moveAction != null)
            {
                if (moveAction.phase == InputActionPhase.Started || moveAction.phase == InputActionPhase.Performed)
                    InputMediator.ConsumeControl(moveAction, false);

                if (moveAction.phase == InputActionPhase.Canceled || moveAction.phase == InputActionPhase.Waiting)
                    InputMediator.ReleaseControl(moveAction, false);
            }
        }
